...
if opcion == "1. Simular / Solicitar Crédito (POS)":
  ...
  if df_comercios.empty:
    ...
    # =============================================================================
# GENERACIÓN E IMPRESIÓN DEL TICKET POS
# =============================================================================

# 1. Obtención segura del logo del comercio
logo_comercio_b64 = ""
try:
  df_logo = conn.query(
...
# 2. Estilos CSS de impresión (CADENA NORMAL - SIN 'f' AL INICIO)
css_impresion = """
<style>
@media print {
...
# 4. Botón de Impresión con JavaScript
js_impresion = """
    <script>
...
"""
components.html(js_impresion, height=65)
